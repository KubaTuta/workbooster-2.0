...
export const macadamMap = {
  ...
  plate: { column: 3 },
  // macadamNoPrice: {column: 11},
  macadamWithPrice: { column: 12, isHyperlink: true },
  // macadamMileage: {column: 14},
};

export const damageMap = {
  plate: { column: 1 },
  damageDate: { column: 3, isDate: true, isArrayValue: true },
  damageCost: { column: 18, isArrayValue: true },
  damageType: { column: 24, isArrayValue: true },
};
